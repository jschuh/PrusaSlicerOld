...
msbuild /m ALL_BUILD.vcxproj /p:Configuration=%PS_CONFIG% /verbosity:Minimal || GOTO :END
cd ..\..
...
IF "%PS_STEPS%" NEQ "app-cmake" msbuild /m ALL_BUILD.vcxproj /p:Configuration=%PS_CONFIG% /verbosity:Minimal || GOTO :END
